...
/**
 * Servlet implementation class DeleteOldSessions
 */
public class DeleteOldSessions extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    SessionData.removeAllOldSessions();
    CableKeyPair.removeAllOldKeyPairs();
  }
